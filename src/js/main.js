...
el.innerHTML = `
    <div class="accordion-header w-full py-3 px-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="w-10 h-10 border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-brand-orange group-hover:text-brand-orange transition-all duration-300 transform group-[.active]:rotate-180 group-[.active]:bg-brand-orange group-[.active]:text-white group-[.active]:border-brand-orange shrink-0 ml-4">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>
        </div>
    </div>
    
    <div class="accordion-body">
        <div class="px-0 md:px-8 bg-gray-50/50 border-t border-gray-100/50">
            <div class="pb-10 pt-2 pl-0 md:pl-[12.5rem]"> 
                <p class="text-gray-600 leading-relaxed mb-10 text-lg font-light max-w-none">${item.teaser}</p>
                <div class="grid md:grid-cols-2 gap-10">
                    
                    <div>
                        <h4 class="text-xs font-bold text-brand-900 uppercase tracking-widest mb-6 flex items-center gap-3"><span class="w-8 h-[1px] bg-brand-orange"></span> Key Learning Areas</h4>
                        <ul class="space-y-4">${focusItems}</ul>
                    </div>
                    
                    <div class="relative p-5 md:p-6 mt-4 md:mt-0 group/card">
                        
                        <div class="absolute top-0 right-0 w-[85%] h-[75%] border-t-2 border-r-2 border-brand-900 pointer-events-none transition-colors duration-300 group-hover:border-brand-orange"></div>
                        
                        <div class="absolute bottom-0 left-0 w-[85%] h-[75%] border-b-2 border-l-2 border-brand-900 pointer-events-none transition-colors duration-300 group-hover:border-brand-orange"></div>
                        
                        <svg class="absolute -top-3 left-0 w-7 h-7 text-brand-900 transition-colors duration-300 group-hover:text-brand-orange" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z"/></svg>
                        
                        <svg class="absolute -bottom-3 right-0 w-7 h-7 text-brand-900 transition-colors duration-300 group-hover:text-brand-orange" fill="currentColor" viewBox="0 0 24 24"><path d="M9.983 3v7.391c0 5.704-3.731 9.57-8.983 10.609l-.995-2.151c2.432-.917 3.995-3.638 3.995-5.849h-4v-10h9.983zm14.017 0v7.391c0 5.704-3.748 9.57-9 10.609l-.996-2.151c2.433-.917 3.996-3.638 3.996-5.849h-3.983v-10h9.983z"/></svg>

                        <div class="relative z-10 pl-2">
                            <h4 class="text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Outcome</h4>
                            <p class="text-brand-900 font-sans text-base md:text-lg font-bold italic leading-relaxed">${item.outcome}</p>
                        </div>
                    </div>
                    </div>
            </div>
